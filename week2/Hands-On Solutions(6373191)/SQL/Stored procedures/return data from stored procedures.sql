...
IF OBJECT_ID('sp_GetEmployeeCountForAllDepartments', 'P') IS NOT NULL
    DROP PROCEDURE sp_GetEmployeeCountForAllDepartments;
GO

-- Create procedure to get employee count for all departments
CREATE PROCEDURE sp_GetEmployeeCountForAllDepartments
AS
BEGIN
    SELECT 
        D.DepartmentName,
...
EXEC sp_GetEmployeeCountForAllDepartments;
